...
@section('content')
    <div class="container-fluid py-2">
        ...
        {{-- Header dengan Tombol Kembali (Diselaraskan dengan Create/Edit Ujian) --}}
        ...
        {{-- Daftar Soal --}}
        <div class="row">
            <div class="col-12"> {{-- Dikembalikan ke col-12 biar full ke samping --}}
                    ...
                    <div class="card border-0 shadow-sm rounded-4 question-card mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3 pb-2 border-bottom">
                                ...
                                {{-- Tombol Edit & Hapus langsung dikeluarkan dari dropdown --}}
    ...
    <div class="modal fade" id="modalTambahSoal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            ...
            {{-- Tag form digabungkan dengan modal-content agar scrollable berfungsi! --}}
    ...
    <div class="modal fade" id="modalEditSoal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            ...
            {{-- Tag form digabungkan dengan modal-content --}}
    ...
    {{-- ========================================================== --}}
    <style>
        /* Sinkronisasi warna background dengan form create/edit */
        .bg-light {
        ...
        /* Custom Input Group (untuk Opsi Jawaban di Modal) */
        .custom-input-group {
            border-radius: 12px;
            overflow: hidden;
        ...
        .custom-input-group.edit-focus:focus-within {
            border-color: #cbd5e1;
            box-shadow: 0 0 0 4px rgba(203, 213, 225, 0.2);
        }

        .custom-input-group.edit-focus-warning:focus-within {
            border-color: #ffc107;
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.btn-edit-soal').on('click', function() {
                ...
                let updateUrl =
                    "{{ route('guru.exams.questions.update', ['id' => $exam->id, 'question_id' => ':qid']) }}";
