    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('guru.exams.create') }}"
                class="btn btn-success rounded-pill px-4 shadow-sm fw-bold border-0 transition-3d">
                                ...
                                <td class="text-center pe-4">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <a href="{{ route('guru.exams.questions', $exam->id) }}"
                                            class="btn btn-sm btn-primary rounded-3 shadow-sm d-flex align-items-center"
                                            title="Kelola Soal">
                                        ...
                                        <a href="{{ route('guru.exams.edit', $exam->id) }}"
                                            class="btn btn-sm btn-outline-warning rounded-3" title="Edit Ujian">
                                        ...
                                        {{-- Tombol On/Off --}}
                                        <form action="{{ route('guru.exams.toggle-status', $exam->id) }}" method="POST"
                                            class="m-0">
                                            @csrf
                                            <button type="submit"
                                                class="btn btn-sm {{ $exam->status == 'aktif' ? 'btn-danger' : 'btn-success' }} rounded-3 transition-3d"
                                                title="{{ $exam->status == 'aktif' ? 'Tutup Ujian' : 'Buka Ujian' }}">
